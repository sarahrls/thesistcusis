...
<body>
  <div class="sidebar">
    <div class="logo-details">
         <img src="<?php echo (!empty($user['photo'])) ? '../images/'.$user['photo'] : '../images/tculogo.png'; ?>" style="margin-right:10px; width:50px; font-family:Poppins;  height:50px;">
          <a href="<?php echo WEB_ROOT; ?>admin/index.php" class="logo_name" style="font-family:poppins; font-size:25px;">TCUSIS
        </a>
