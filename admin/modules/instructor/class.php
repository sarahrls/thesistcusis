				  	...
				  	global $mydb;
				  		...
				  		function loadresult(){
                            ...
                            $decrypted_SEX = $aes->decryptData($student->SEX);
					  		...
					  		echo '<td><a href="index.php?view=grade&classId='.$_GET['id'].'&gradeId='.$student->GRADE_ID.'&instructorId='.$_GET['instructorId'].'" style="color:#780000; font-size:15px; font-family:Poppins; font-weight:500;">'. $decrypted_LNAME. ', ' .$decrypted_FNAME.' '.$decrypted_MNAME.'</a></td>';
