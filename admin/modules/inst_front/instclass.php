	...
	*/
    ...
    You could also use a data-* attribute and content for this. That way "bloats" the HTML, this way means you need to keep HTML and CSS in sync. Lea Verou has a clever way to handle with text-shadow.
		*/
		...
		td:nth-of-type(6):before { content: "Specialization"; }
		td:nth-of-type(7):before { content: "Email Address"; }
				  	...
				  	global $mydb;
				  		...
				  		function loadresult(){
                            ...
                            $decrypted_REMARKS = $aes->decryptData($student->REMARKS);
					  		...
					  		echo '<td style="font-size:15px; font-family:Poppins; font-weight:500; margin-left:10px;"><a href="index.php?view=grade&classId='.$_GET['id'].'&gradeId='.$student->GRADE_ID.'&instructorId='.$_GET['instructorId'].'" style="color:#780000; font-size:14px;">'. $decrypted_LNAME. ', ' .$decrypted_FNAME.' '.$decrypted_MNAME.'</a></td>';
