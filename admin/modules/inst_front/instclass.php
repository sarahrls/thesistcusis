				  	...
				  	global $mydb;
				  		...
				  		function loadresult(){
							...
							foreach ($cur as $student) {
					  		...
					  		echo '<td style="font-size:15px; font-family:Poppins; font-weight:500; margin-left:10px;"><a href="index.php?view=grade&classId='.$_GET['id'].'&gradeId='.$student->GRADE_ID.'&instructorId='.$_GET['instructorId'].'" style="color:#780000; font-size:14px;">'. $student->LNAME. ',' .$student->FNAME.' '.$student->MNAME.'</a></td>';
